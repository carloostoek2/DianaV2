...
``knowledge.profile`` is requestable via optional ``needs_profile`` (default False).
"""
...
# Stable capability order (Anexo C.2 / L5). Profile after voice, before memory.
_NEED_TO_CAPABILITY: tuple[tuple[str, str], ...] = (
    ...
    ("needs_profile", "knowledge.profile"),
