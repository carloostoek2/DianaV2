...
def test_orm_exposes_exactly_twenty_five_tables() -> None:
    """8 F1 + 8 F2 knowledge + 3 F3 proactivity + owner_marks + business_connections + runtime_timers + persona_versions + daily_message_limits + atencion_cycles = 25 total."""
