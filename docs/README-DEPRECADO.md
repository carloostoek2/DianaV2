> ⚠️ **DEPRECADO — DOCUMENTO HISTÓRICO**
>
> Este documento fue reemplazado por los nuevos documentos principales de la
> raíz del proyecto: `README.md` y `CHANGELOG.md`. Se conserva en `docs/`
> únicamente como referencia histórica y ya no se actualiza.
