...
| `LLM_THINKING_ENABLED` | **true** | DeepSeek thinking on free-text drafts only (`reasoning_effort=low`; cap-empty retry then thinking-off fallback; not a menu button) |
